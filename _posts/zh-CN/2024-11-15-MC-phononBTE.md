...
<div class="text-center">
  {% include figure.liquid path="assets/img/blog/peri_bond.png" zoomable=true caption="图 1: 偏差能量示意图" class="w-75" %}
</div>
...
<div class="text-center">
  {% include figure.liquid path="assets/img/blog/peri_bond.png" zoomable=true caption="图 2: 周期性边界条件" class="w-75" %}
</div>
