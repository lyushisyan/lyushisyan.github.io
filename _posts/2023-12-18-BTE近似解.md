...
$$
\Gamma_\lambda = \frac{\pi \hbar}{16N} \sum_{\lambda' \lambda''} |\Gamma_{\lambda \lambda' \lambda''}|^2 \bigg\{ [f_{\lambda'}^0 + f_{\lambda''}^0 + 1] \delta(E_\lambda - E_{\lambda'} - E_{\lambda''}) + [f_{\lambda'}^0 - f_{\lambda''}^0] \big[ \delta(E_\lambda + E_{\lambda'} - E_{\lambda''}) - \delta(E_\lambda - E_{\lambda'} + E_{\lambda''}) \big] \bigg\}
$$
